	...
	<div class="sense" :style="fixedStyle">
		...
		<div v-else>
			...
			<div class="option">
				<div class="select">
					<div class="type">
						<CusSelect selecName="type" :options="typeList" @select="handleTypeSelect" @fixedTo="handleFixStyle"></CusSelect>
					</div>
					<div class="sort">
						<CusSelect selecName="sort" :options="sortList" @select="handleSortSelect" @fixedTo="handleFixStyle"></CusSelect>
					</div>
				</div>
